...
test("generar paquetes y avanzar 1 tiempo en el mapa", () => {
    mapa.matriz[0][0].generarPaquete(0,[["remera",4],["buzo",2]],8);
    mapa.matriz[0][0].generarPaquete(0,[["remera",10],["buzo",8]],6);
    mapa.matriz[0][0].generarPaquete(0,[["teclado",5]],6);
    mapa.matriz[0][0].generarPaquete(0,[["pantalon",3],["campera",1]],8);
    mapa.matriz[0][0].generarPaquete(0,[["celular",3]],4);
    mapa.avanzarTiempo(reloj);
